module ball (
    ...
    // === Parameters ===
    parameter logic [9:0] Ball_X_Center  = 10'd250;
    parameter logic [9:0] Ball_Y_Center  = 10'd16;
    parameter logic [9:0] Ball_Y_Min     = 10'd8;
    parameter logic [9:0] Ball_Y_Max     = 10'd450;
    parameter logic [9:0] Jetpack_Thrust = 10'd2;     // Reduced thrust for better control
    parameter logic [9:0] Ball_Size      = 10'd16;
    parameter logic [9:0] Max_Fall_Speed = 10'd8;
    parameter logic [9:0] Max_Rise_Speed = 10'd8;    // Matched rise/fall limits
