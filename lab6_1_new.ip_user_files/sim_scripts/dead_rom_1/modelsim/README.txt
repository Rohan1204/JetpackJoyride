...
#
# Generated by export_simulation on Mon Apr 28 13:42:33 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './dead_rom.sh' script.

./dead_rom.sh -reset_run
...
./dead_rom.sh -noclean_files

For more information on the script, please type './dead_rom.sh -help'.
