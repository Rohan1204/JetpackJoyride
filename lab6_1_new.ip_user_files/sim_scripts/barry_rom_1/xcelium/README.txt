...
#
# Generated by export_simulation on Tue Apr 29 15:40:03 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './barry_rom.sh' script.

./barry_rom.sh -reset_run
...
./barry_rom.sh -noclean_files

For more information on the script, please type './barry_rom.sh -help'.
