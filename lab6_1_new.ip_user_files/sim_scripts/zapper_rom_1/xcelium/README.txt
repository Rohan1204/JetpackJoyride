...
#
# Generated by export_simulation on Tue Apr 29 14:33:19 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './zapper_rom.sh' script.

./zapper_rom.sh -reset_run
...
./zapper_rom.sh -noclean_files

For more information on the script, please type './zapper_rom.sh -help'.
